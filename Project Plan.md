[Project Plan](https://docs.google.com/document/d/17g3G-rhqDQWOvV1R9ARx8ZFBCGkuDVhH/edit).
...
Eric Neumann
	...
	b-i. 
	The goal of this project is to create an application that solves multiple video game forum’s problems. What we are trying to solve is to make an application that combines the current forums and puts them all in one place, not needing to go to fifty different forum websites. This application will include all the news in one single place from a variety of games and companies. 
